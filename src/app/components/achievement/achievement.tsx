...
const Achievement =()=>{
    return(
        <div id="achievement" className="max-w-[1280px] h-[488px]  py-[112px] flex flex-col gap-[24px] items-center bg-secondary max-sm:max-w-[428px] max-sm:pt-[48px] max-sm:px-[24px]  overflow-hidden max-sm:overflow-hidden">
            <div className="w-[1152px]  flex flex-col gap-[24px]  m-auto max-sm:max-w-[380px] max-sm:h-[147px] ">
               ...
               <p className=" max-sm:w-[380px]  max-sm:text-center  max-sm:px-7 max-sm:block hidden " > Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. </p>
            ...
            <div>
                <h1 className="font-roboto font-[700] text-[40px] text-primary max-sm:text-[20px] max-sm:font-700"> +200 </h1>
                <p className="font-roboto font-[400] text-[16px] text-center text-primary"> Courses </p>
            </div>

            <div>
                <h1 className="font-roboto font-[700] text-[40px] text-primary max-sm:text-[20px] max-sm:font-700"> 50K </h1>
                <p className="font-roboto font-[400] text-[16px] text-center text-primary"> Mentors </p>
            </div>

            <div>
                <h1 className="font-roboto font-[700] text-[40px] text-primary max-sm:text-[20px] max-sm:font-700"> 370k </h1>
                <p className="font-roboto font-[400] text-[16px] text-center text-primary"> Students </p>
            </div>

            <div>
                <h1 className="font-roboto font-[700] text-[40px] text-primary max-sm:text-[20px] max-sm:font-700"> 100+ </h1>
