...
const Achievement2 =()=>{
    return(
        <div className="max-w-[1280px] h-[488px]  py-[112px] flex flex-col gap-[24px] items-center bg-secondary max-sm:hidden overflow-hidden max-sm:overflow-hidden ">
            <div className="w-[1152px] flex flex-col gap-[24px]  m-auto ">
                <h1 className="font-roboto font-[700] text-[48px] text-center text-primary"> Our Achivements </h1>
                <p className="w-[1152px]  font-roboto font-[400] text-[18px] text-center text-primary px-14 leading-[27px]"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat. </p>
            </div>
