...
const ExploreCourses =()=>{
    return(
        <div className="h-[1049px] max-w-[1280px] bg-secondary py-[112px] max-sm:max-w-[428px] max-sm:py-[48px] max-sm:px-[24px]  overflow-hidden max-sm:overflow-hidden max-sm:h-[862px]">
            {/* heading */}
            <div className="max-w-[768px] pb-[70px]  m-auto  flex flex-col gap-[24px] max-sm:w-[385px] max-sm:h-[162px]  max-sm:text-center max-sm:m-auto">
                ...
                <p className="font-roboto font-[400] text-[18px] text-primary max-sm:text-[18px] max-sm:w-[385px] max-sm:pr-4"> Discover a wide range of courses covering a variety of subjects, taught by expert instructors.</p>
            </div>

            {/* courses container */}
            <div className="h-[636px]  grid grid-cols-3 grid-rows-3 gap-[24px] max-sm:grid-cols-1 max-sm:grid-rows-3 max-sm:gap-[24px] max-sm:mt-14 max-sm:h-auto max-sm:mb-16">
