...
const Footer =()=>{
    return(
        <div className="max-w-[1280px] h-[684px] p-[80px] gap-[80px] bg-secondary  overflow-x-hidden max-sm:overflow-x-hidden max-sm:py-[48px] max-sm:px-[24px] max-sm:gap-[48px] max-sm:h-auto">
            
            {/* container */}
            <div className="max-w-[1120px] h-[524px]  flex flex-col gap-[80px]  m-auto max-sm:h-auto max-sm:flex-col ">
               
                 {/* TOP */}
                <div className=" h-[82px]  flex justify-between max-md:flex-col  max-sm:h-auto max-sm:flex max-sm:gap-[24px]">
                    ...
                    <div className="max-sm:h-[91px] max-sm:w-[287px] max-sm:mx-auto max-sm:text-center max-sm:pr-8 " >
                        ...
                        <p className="font-roboto font-[400] text-[16px] text-primary max-sm:pt-3"> Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>

                    {/* top right input/para */}
                    <div className="flex flex-col justify-between max-sm:flex-col max-sm:h-[146px] max-sm:gap-[16px] ">
                        <div className="h-[48px]  flex gap-[16px] max-sm:flex-col max-sm:h-auto ">
                        <input type="text" id="email" placeholder="Enter your email" required className="border-primary border-[1px] rounded-[5px] pl-2 w-[265px] max-sm:w-full max-sm:h-[48px] "/>
                ...
                {/* MID */}
                <div className=" h-[225px] grid grid-cols-4 gap-[40px] max-sm:h-auto max-sm:w-[172px] max-sm:mx-auto max-sm:grid-cols-1  ">
               ...
               {/* BOTTOM */}
                <div className=" h-[57px] max-w-[1120px] max-sm:h-auto max-sm:flex-col justify-around">
